...
var db = {};
var sequelize = new _sequelize["default"](_config["default"][env].database, _config["default"][env].username, _config["default"][env].password, _config["default"][env]);
...
db.AreaProgress = require('./area_progress_TBL')(sequelize, _sequelize["default"]);
db.Area_Data = require('./area_design_data_TBL')(sequelize, _sequelize["default"]);
...
db.ModelRelation = require('./pipe_model_relation_TBL')(sequelize, _sequelize["default"]);
...
db.Obstruction_Type = require('./obstruction_type_TBL')(sequelize, _sequelize["default"]); // 종류들 
...
db.ObsModelRelation = require('./obstruction_model_relation_TBL')(sequelize, _sequelize["default"]);
db.ObsManhole = require('./obstruction_manhole_model_TBL')(sequelize, _sequelize["default"]);
db.ObsRelation = require('./obs_relation_TBL')(sequelize, _sequelize["default"]);
...
db.AreaBluePoint = require('./area_blue_print_TBL')(sequelize, _sequelize["default"]);
db.BluePointCrossPoint = require('./blue_print_crossPoint_TBL')(sequelize, _sequelize["default"]);
db.BluePointEndValue = require('./blue_print_endValue_TBL')(sequelize, _sequelize["default"]);
db.BluePointMissingNode = require('./blue_print_missingNode_TBL')(sequelize, _sequelize["default"]);
db.BluePointMissingValue = require('./blue_print_missingValue_TBL')(sequelize, _sequelize["default"]);
db.BluePointStartValue = require('./blue_print_startValue_TBL')(sequelize, _sequelize["default"]);
db.BluePointManhole = require('./blue_print_manhole_TBL')(sequelize, _sequelize["default"]);
db.BluePointQuantity = require('./blue_print_quantity_TBL')(sequelize, _sequelize["default"]);
db.BluePointCertification = require('./blue_print_certification_TBL')(sequelize, _sequelize["default"]);
...
db.FacilityRelation = require('./facility_model_relation_TBL')(sequelize, _sequelize["default"]); // facility info table

db.FacilityFormInfo = require('./facility_form_info_TBL')(sequelize, _sequelize["default"]);
db.FacilityTypeInfo = require('./facility_type_info_TBL')(sequelize, _sequelize["default"]);
db.FacilityUsageInfo = require('./facility_usage_info_TBL')(sequelize, _sequelize["default"]);
db.FacilityVersionInfo = require('./facility_info_version_TBL')(sequelize, _sequelize["default"]); // app version

db.MobileVersion = require('./mobile_version_TBL')(sequelize, _sequelize["default"]); // relation
...
db.BluePointStartValue.hasOne(db.AreaBluePoint, {
  foreignKey: "startPoint"
}, {
  onDelete: 'cascade'
});
db.BluePointEndValue.hasOne(db.AreaBluePoint, {
  foreignKey: "endPoint"
}, {
  onDelete: 'cascade'
});
db.BluePointCrossPoint.hasOne(db.AreaBluePoint, {
  foreignKey: "crossPoint"
}, {
  onDelete: 'cascade'
});
db.BluePointMissingNode.hasOne(db.AreaBluePoint, {
  foreignKey: "missingNode"
}, {
  onDelete: 'cascade'
});
db.BluePointMissingValue.hasOne(db.AreaBluePoint, {
  foreignKey: "missingValve"
}, {
  onDelete: 'cascade'
});
db.BluePointStartValue.hasMany(db.Valve, {
  foreignKey: 'idStartValve'
}, {
  onDelete: 'cascade'
});
db.Valve.belongsTo(db.BluePointStartValue, {
  foreignKey: 'idStartValve'
}, {
  onDelete: 'cascade'
});
db.BluePointEndValue.hasMany(db.Valve, {
  foreignKey: 'idEndValve'
}, {
  onDelete: 'cascade'
});
db.Valve.belongsTo(db.BluePointEndValue, {
  foreignKey: 'idEndValve'
}, {
  onDelete: 'cascade'
});
db.BluePointCrossPoint.hasMany(db.Valve, {
  foreignKey: 'idCross'
}, {
  onDelete: 'cascade'
});
db.Valve.belongsTo(db.BluePointCrossPoint, {
  foreignKey: 'idCross'
}, {
  onDelete: 'cascade'
});
db.BluePointMissingNode.hasMany(db.Valve, {
  foreignKey: 'idMissNode'
}, {
  onDelete: 'cascade'
});
db.Valve.belongsTo(db.BluePointMissingNode, {
  foreignKey: 'idMissNode'
}, {
  onDelete: 'cascade'
});
db.BluePointMissingValue.hasMany(db.Valve, {
  foreignKey: 'idMissValue'
}, {
  onDelete: 'cascade'
});
db.Valve.belongsTo(db.BluePointMissingValue, {
  foreignKey: 'idMissValue'
}, {
  onDelete: 'cascade'
}); // sequelize.sync();
