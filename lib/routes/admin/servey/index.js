...
router.get('', /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(req, res) {
    var sort, order, fid, fids, servey_all;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            ;
            _context.next = 9;
            return _models["default"].Servey.findAndCountAll({
          ...
          case 9:
            servey_all = _context.sent;

            _lodash["default"].map(servey_all.rows, function (e, i) {
              var imgs = [];
              var image = e.img.split(",");
              image.map(function (servey_all) {
                var img = {};
                img.img = servey_all;
                imgs.push(img);
              });
            ...
            res.setHeader('Content-Range', "0-5/".concat(servey_all.count));
            res.setHeader('X-Total-Count', "".concat(servey_all.count));
            res.send(servey_all.rows);
            _context.next = 22;
            break;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _models["default"].Servey.findOne({
              where: {
                fid: req.params.id
              }
            });
          ...
          case 3:
            servey_one = _context2.sent;
            imgs = [];
            image = servey_one.img.split(",");
            image.map(function (data) {
              var img = {};
              img.img = data;
              imgs.push(img);
            });
            servey_one.dataValues.imgs = imgs;
            servey_one.dataValues.id = req.params.id;
            servey_one.dataValues.lat = servey_one.dataValues.latlon.coordinates[0];
            servey_one.dataValues.lon = servey_one.dataValues.latlon.coordinates[1];
            res.setHeader('Access-Control-Expose-Headers', 'Content-Range');
            res.setHeader('Access-Control-Expose-Headers', 'X-Total-Count');
...
router.post('', /*#__PURE__*/function () {
  var _ref3 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(req, res, next) {
    var transaction, findArea, img_name, fid, date, filePath, point, create_servey;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 6:
            ...
            _context3.next = 16;
            return _models["default"].Servey.create({
              fid: fid,
              latlon: point,
              alt: req.body.alt,
              geo: req.body.geo,
          ...
          case 16:
            create_servey = _context3.sent;
            _context3.next = 19;
            return transaction.commit();

          case 19:
            res.send(create_servey);
            _context3.next = 29;
            break;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 6:
            ...
            _context4.next = 13;
            return _models["default"].Servey.update({
              latlon: {
                type: 'Point',
                coordinates: [req.body.lat, req.body.lon]
              },
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return _models["default"].Servey.destroy({
              where: {
                fid: req.params.id
              }
            });
