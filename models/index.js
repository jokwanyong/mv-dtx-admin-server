...
const env = process.platform === 'linux' ? 'production' : 'development';
...
// obstruction model
db.ObsModelRelation = require('./obstruction_model_relation_TBL')(sequelize, Sequelize);
db.ObsManhole = require('./obstruction_manhole_model_TBL')(sequelize, Sequelize);
...
db.BluePointCrossPoint = require('./blue_print_crossPoint_TBL')(sequelize, Sequelize);
db.BluePointEndValue = require('./blue_print_endValue_TBL')(sequelize, Sequelize);
db.BluePointMissingNode = require('./blue_print_missingNode_TBL')(sequelize, Sequelize);
db.BluePointMissingValue = require('./blue_print_missingValue_TBL')(sequelize, Sequelize);
db.BluePointStartValue = require('./blue_print_startValue_TBL')(sequelize, Sequelize);
db.BluePointManhole = require('./blue_print_manhole_TBL')(sequelize, Sequelize);
db.BluePointQuantity = require('./blue_print_quantity_TBL')(sequelize, Sequelize);
db.BluePointCertification = require('./blue_print_certification_TBL')(sequelize, Sequelize);
...
db.FacilityRelation = require('./facility_model_relation_TBL')(sequelize, Sequelize);
...
db.FacilityUsageInfo = require('./facility_usage_info_TBL')(sequelize, Sequelize);
db.FacilityVersionInfo = require('./facility_info_version_TBL')(sequelize, Sequelize);
...
db.BluePointStartValue.hasOne(db.AreaBluePoint, {foreignKey: "startPoint"}, { onDelete: 'cascade'});
db.BluePointEndValue.hasOne(db.AreaBluePoint, {foreignKey: "endPoint"}, { onDelete: 'cascade'});
db.BluePointCrossPoint.hasOne(db.AreaBluePoint, {foreignKey: "crossPoint"}, { onDelete: 'cascade'});
db.BluePointMissingNode.hasOne(db.AreaBluePoint, {foreignKey: "missingNode"}, { onDelete: 'cascade'});
db.BluePointMissingValue.hasOne(db.AreaBluePoint, {foreignKey: "missingValve"}, { onDelete: 'cascade'});

db.BluePointStartValue.hasMany(db.Valve, {foreignKey: 'idStartValve'}, { onDelete: 'cascade'});
db.Valve.belongsTo(db.BluePointStartValue, {foreignKey: 'idStartValve'}, { onDelete: 'cascade'});

db.BluePointEndValue.hasMany(db.Valve, {foreignKey: 'idEndValve'}, { onDelete: 'cascade'});
db.Valve.belongsTo(db.BluePointEndValue, {foreignKey: 'idEndValve'}, { onDelete: 'cascade'});

db.BluePointCrossPoint.hasMany(db.Valve, {foreignKey: 'idCross'}, { onDelete: 'cascade'});
db.Valve.belongsTo(db.BluePointCrossPoint, {foreignKey: 'idCross'}, { onDelete: 'cascade'});

db.BluePointMissingNode.hasMany(db.Valve, {foreignKey: 'idMissNode'}, { onDelete: 'cascade'});
db.Valve.belongsTo(db.BluePointMissingNode, {foreignKey: 'idMissNode'}, { onDelete: 'cascade'});

db.BluePointMissingValue.hasMany(db.Valve, {foreignKey: 'idMissValue'}, { onDelete: 'cascade'});
db.Valve.belongsTo(db.BluePointMissingValue, {foreignKey: 'idMissValue'}, { onDelete: 'cascade'});
